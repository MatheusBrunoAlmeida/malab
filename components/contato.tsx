      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-gray-300">
            Estamos à disposição para esclarecer dúvidas, agendar
            atendimentos e oferecer suporte jurídico com agilidade, sigilo e
            responsabilidade.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="mensagem" className="block text-sm mb-2">Mensagem</label>
              <Textarea 
                id="mensagem" 
