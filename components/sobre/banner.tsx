        ...
        <div className="flex px-20 lg:flex-row flex-col bg-[url('/banner-bg.png')] bg-cover bg-center">
            <div className="flex mt-10 lg:mt-0 px-10 lg:px-0 flex-col justify-center items-center">
                <div className="flex flex-col gap-4">
                    <span className="font-sora lg:text-xl text-white text-[0.5rem] font-semibold tracking-[5px]">MALAB ADVOGADOS ASSOCIADOS</span>
                    ...
                    <div className="flex lg:flex-row flex-col gap-4">
                        ...
                        <Button size="lg" className="bg-trasnparent text-white border-[0.5px] border-white lg:py-7 rounded-[10px]">Conheça nossas áreas de atuação</Button>
                    </div>
                </div>
            </div>
            <Image src="/banner-image-sobre.svg" alt="Lady Justice statue" width={750} height={1000} priority />
        </div>
    )
}
