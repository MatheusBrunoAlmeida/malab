                ...
                <div className="flex-1 pr-6">
                    <div className="mb-8">
                        ...
                        <p className="text-[#29333A] font-sora mb-8">
                            Estamos à disposição para esclarecer dúvidas, agendar <br />
                            atendimentos e oferecer o suporte jurídico que você ou sua empresa precisam.
                        </p>
                        <div className="flex lg:flex-row flex-col gap-10">
                            <Link href="#" className="flex items-center rounded-lg bg-transparent gap-2 transition-all duration-300 md:hover:transform md:hover:scale-105">
                                <Image src="/instagram-icon.svg" alt="Link para o Instagram" width={40} height={40} />
                                <span>Instagram</span>
                            </Link>

                            <Link href="#" className="flex items-center gap-2 transition-all duration-300 md:hover:transform md:hover:scale-105">
                                <Image src="/facebook-icon.svg" alt="Link para o Facebook" width={40} height={40} />
                                <span>Facebook</span>
                            </Link>
                        </div>
